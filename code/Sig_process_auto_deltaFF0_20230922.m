...
%folderpath='F:\SynologyDrive\LAB-share\Member-HuJiaHao\LiLiang\Data\';
    folderpath='C:\Users\ElPsyCongroo\Desktop\Carbachol\Slice imaging\WT\';
    dataname='20230217Ctrl_NAc2site5_Carbachol_deepcad_output';
    fs=10;%采样频率，单位Hz
    r_um=50;%用来框选的圆的半径,单位um
    pixsize=0.425;%像素尺寸大小，单位um/pix
    thresh_color=0.5;%colormap中最大值白色对应的ΔF/F0
    thresh_select=0.05;%荧光变化量选取阈值
    thresh_electrode=5000;%用于圈出电极的本底荧光阈值
    bp1=1.5;%拟合的断点1
    bp2=5;%拟合的断点2
%%%%%%%%%%%%%%%%%%%%%%%以上为可调参数%%%%%%%%%%%%%%%%%%%%%%%
r_pix=r_um/pixsize;
